...
public class WishListData {
    ...
    public WishListData(String product_id, String product_name, byte[] product_image, String product_desc, String product_actual_price, String product_selling_price, int liked ) {
